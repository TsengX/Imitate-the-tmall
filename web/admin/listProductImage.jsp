                        ...
                        <div class="panel-body">
                            <form method="post" class="addFormSingle" action="admin_productImage_add" enctype="multipart/form-data">
                                <table class="addTable">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="file" id="filepathSingle" name="filepath" accept="image/*">
                                        </td>
                                    </tr>
                                    <tr class="submitTR">
                                        <td align="center">
                    ...
                    <table class="table table-striped table-bordered table-hover  table-condensed">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>${pi.id}</td>
                                <td>
                                    <a href="img/productSingle/${pi.id}.jpg" title="点击查看原图">
                                        <img src="img/productSingle/${pi.id}.jpg">
                                    </a>
                                </td>
                                <td>
                                    <a href="admin_productImage_delete?id=${pi.id}" deleteLink="true">
