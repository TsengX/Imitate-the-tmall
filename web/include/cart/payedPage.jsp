...
<div class="payedDiv">
    ...
    <div class="payedAddressInfo">
        <ul>
            ...
            <li>实付款：
                <span>￥<fmt:formatNumber type="number" value="${param.total}" minFractionDigits="2"/></span>
            </li>
            <li>预计09月08日送达 </li>
        </ul>
    ...
    <div class="warningDiv">
        ...
        <p>
            <b>安全提醒：</b>下单后，
            <span class="redColor boldWord">用QQ给您发送链接办理退款的都是骗子！</span>天猫不存在系统升级，订单异常等问题，谨防假冒客服电话诈骗！
        </p>
    </div>
